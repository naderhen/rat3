class BoardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @board.save
        format.html { redirect_to [@organization, @board], notice: 'Board was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @board.update(board_params)
        format.html { redirect_to [@organization, @board], notice: 'Board was successfully updated.' }
