    ...
    this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement',
      function( $rootScope,   $browser,   $sniffer,   $rootElement) {
        ...
        $rootElement.bind('click', function(event) {
          ...
          // TODO NH 05/27/2013: by default, angular checks to ensure there is no target on the link. I've decided to explicitly add a target for links I want angular to intercept.
          // This will break on future updates, but hopefully they come up with a less intrusive way to handle cases like this
          if (absHref && elm.attr('target') == "_intercept" && rewrittenUrl) {
